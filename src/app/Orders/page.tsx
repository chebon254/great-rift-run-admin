          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-[#F7F9FC] text-left dark:bg-dark-2">
                <th className="min-w-[220px] px-4 py-4 font-medium text-dark xl:pl-7">
                  Order ID
                </th>
                <th className="min-w-[220px] px-4 py-4 font-medium text-dark xl:pl-7">
                  Name
                </th>
                <th className="min-w-[150px] px-4 py-4 font-medium text-dark">
                  Order date
                </th>
                <th className="min-w-[120px] px-4 py-4 font-medium text-dark">
                  Status
                </th>
                <th className="px-4 py-4 text-right font-medium text-dark xl:pr-7">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody>
              {packageData.map((packageItem, index) => (
                <tr key={index}>
                  <td
                    className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7 ${
                  ...
                  >
                    <h5 className="text-dark">{packageItem.name}</h5>
                  </td>
                  <td
                  ...
                  >
                    <p className="text-dark">{packageItem.invoiceDate}</p>
                  </td>
                  <td
                    className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${
                      index === packageData.length - 1
                  ...
                  <td
                    className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7 ${
                      index === packageData.length - 1
                        ? "border-b-0"
                        : "border-b"
                    }`}
                  >
                    <div className="flex items-center justify-end space-x-3.5">
                      <Link href="/Orders/Order-Detail" className="hover:text-primary">
                        <svg
