...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slugify$2f$slugify$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/slugify/slugify.js [app-route] (ecmascript)");
;
;
;
async function POST(req) {
    try {
        ...
        const slug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slugify$2f$slugify$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(title, {
            lower: true
        });
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].blog.create({
            data: {
                title,
                slug,
                content,
...
async function GET() {
    try {
        const blogs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].blog.findMany({
            orderBy: {
                createdAt: "desc"
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__330c56._.js.map