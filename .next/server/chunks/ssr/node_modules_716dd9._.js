...
const PUBLISHABLE_KEY = ("TURBOPACK compile-time value", "pk_test_aHVtYW5lLWFscGFjYS0zNC5jbGVyay5hY2NvdW50cy5kZXYk") || "";
...
const mergeNextClerkPropsWithEnv = (props)=>{
    ...
    return {
        ...props,
        publishableKey: props.publishableKey || ("TURBOPACK compile-time value", "pk_test_aHVtYW5lLWFscGFjYS0zNC5jbGVyay5hY2NvdW50cy5kZXYk") || "",
...
function debugLogFooter(name) {
    return `[clerk debug end: ${name}] (@clerk/nextjs=${"6.9.5"},next=${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$package$2e$json__$28$json$29$__["default"].version},timestamp=${Math.round(/* @__PURE__ */ new Date().getTime() / 1e3)})`;
}
...
//# sourceMappingURL=node_modules_716dd9._.js.map