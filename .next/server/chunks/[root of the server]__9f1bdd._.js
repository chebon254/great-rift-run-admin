...
async function GET(req, { params }) {
    try {
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].blog.findUnique({
            where: {
...
async function DELETE(req, { params }) {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].blog.delete({
            where: {
                id: parseInt(params.id)
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9f1bdd._.js.map